...
from modules.model_architecture.bert_crf_xlm_roberta import Roberta_token_classification
from modules.datasets.dataset_bert_no_image_roberta import convert_mm_examples_to_features,MNERProcessor
...
if args.do_train:
    ...
    dev_eval_data = TensorDataset(all_input_ids, all_input_mask, all_segment_ids, all_label_ids)
