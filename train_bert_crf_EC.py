...
from modules.model_architecture.bert_crf_EC import BERT_token_classification
from modules.datasets.dataset_bert_EC import convert_mm_examples_to_features,MNERProcessor
...
if args.do_train:
    ...
    train_data = TensorDataset(all_input_ids, all_input_mask,all_segment_ids, all_label_ids,all_input_mask_addition,all_label_ids_addition)
    if args.local_rank == -1:
    ...
    dev_eval_data = TensorDataset(all_input_ids, all_input_mask,all_segment_ids, all_label_ids,all_input_mask_addition,all_label_ids_addition)
    ...
    for train_idx in trange(int(args.num_train_epochs), desc="Epoch"):
        ...
        for step, batch in enumerate(tqdm(train_dataloader, desc="Iteration")):
            ...
            input_ids, input_mask, segment_ids, label_ids, input_mask_addition,label_ids_addition = batch
            neg_log_likelihood = model(input_ids, segment_ids, input_mask, input_mask_addition,label_ids_addition,label_ids)
        ...
        label_map[0] = "PAD"
        for input_ids, input_mask, segment_ids, label_ids, input_mask_addition,label_ids_addition in tqdm(
                dev_eval_dataloader,
                desc="Evaluating"):
            ...
            with torch.no_grad():
                predicted_label_seq_ids = model(input_ids, segment_ids, input_mask, input_mask_addition)
...
if args.do_eval and (args.local_rank == -1 or torch.distributed.get_rank() == 0):
    ...
    eval_data = TensorDataset(all_input_ids, all_input_mask, all_segment_ids, all_label_ids, all_input_mask_addition, all_label_ids_addition)
    # Run prediction for full data
